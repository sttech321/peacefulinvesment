  ...
  return (
    <div className='min-h-screen bg-black pt-16'>
      <button
        ...
        className="fixed left-3 top-3 z-[55] inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-2 text-xs font-medium text-white backdrop-blur transition hover:bg-white/15 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/70"
