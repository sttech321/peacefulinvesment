  ...
  if (!isAdmin()) {
    return (
        ...
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold mb-2 text-white pt-5">Deposit/Withdrawal Requests</h2>
          <p className="text-muted-foreground">Fetching Deposit/Withdrawal data...</p>
        </div>
      </div> 
    );
  }
        ...
        <>
          ...
          <Card className="border border-muted/20 p-0 rounded-lg bg-white/5">
            <CardHeader>
              ...
              <CardDescription>
                {selectedStatusFolder 
                  ? `All ${selectedStatusFolder} requests`
